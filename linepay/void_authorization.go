...
func (c *Client) VoidAuthorization(ctx context.Context, transactionID int64, req *VoidAuthorizationRequest) (*VoidAuthorizationResponse, *http.Response, error) {
	endpoint := fmt.Sprintf("v2/payments/authorizations/%d/void", transactionID)
